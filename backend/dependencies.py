...
from backend.utils.role_helpers import is_admin
...
def get_db():
    ...
    try:
        yield db
        db.commit()  # Commit automatique si pas d'erreur
    except Exception:
